...
public class MainActivity extends AppCompatActivity {
    ...
    public void insertData() {
        ...
        ContentValues values = new ContentValues();
            ...
            /*
            because I specified product name column to has an UNIQUE value, we can put those specific dummy values just once,
            in later stages of the app though, I will have to check first if this specific product is
            already added, and then add it if it's not, or just increment its quantity if it already is in the table
            */
        values.put(InventoryEntry.COLUMN_PRODUCT_NAME, "Foo");
        values.put(InventoryEntry.COLUMN_PRODUCT_PRICE, 235);
        values.put(InventoryEntry.COLUMN_PRODUCT_QUANTITY, 24);
